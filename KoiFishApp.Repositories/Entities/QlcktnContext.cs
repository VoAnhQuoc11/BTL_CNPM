...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__GioHang__B40CC6ED71AFE97A");
        ...
        {
            entity.HasKey(e => e.KoiId).HasName("PK__KoiFish__E03435B80494A400");
        ...
        modelBuilder.Entity<KoiGrowth>(entity =>
        {
            ...
            entity.HasOne(d => d.Koi).WithMany()
                ...
                .HasConstraintName("FK__KoiGrowth__KoiID__403A8C7D");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Koi_Quan__3214EC27BA94A0B6");
        ...
        {
            entity.HasKey(e => e.PondId).HasName("PK__Pond__D18BF8548E48CF4A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6EDC1A41415");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3214EC273830D14C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__WaterPar__3214EC0798DFA314");
